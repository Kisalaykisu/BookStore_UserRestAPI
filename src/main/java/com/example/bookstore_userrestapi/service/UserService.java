...
import com.example.bookstore_userrestapi.exception.UserException;
import com.example.bookstore_userrestapi.model.UserDetails;
import com.example.bookstore_userrestapi.repository.UserRepo;
import com.example.bookstore_userrestapi.utility.EmailSenderService;
import com.example.bookstore_userrestapi.utility.TokenUtility;
...
public class UserService implements IUserService {
    ...
    public String forgotPassword(String email) {
        ...
        if(userDetails != null){
            emailSender.sendEmail(userDetails.getEmailAddress(), "Forgot Password", "Please click on the below link to change password"+"\nhttp://localhost:9090/user/resetPassword");
